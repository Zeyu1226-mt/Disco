...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed):
        ...
        #print(hs.shape) # torch.Size([1, 12, 18, 256])

        return hs.transpose(1, 2), att   # 1,28,12,256
...
def build_token_encoder(args):
    return Transformer(
        ...
        dropout=args.drop_rate,    # 0.1
        nhead=args.nheads,         # 4
        dim_feedforward=args.ffn_dim,     # 512
        num_decoder_layers=args.enc_layers,   # 6
