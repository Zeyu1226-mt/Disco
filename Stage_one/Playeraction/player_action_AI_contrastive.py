...
from player_dataloader.dataloader_AI_contrastive import read_dataset
...
parser.add_argument('--lr_step_down', default=95, type=int, help='step down size (cyclic) for learning rate scheduler')
...
def main():
    ...
    exp_name = 'Full_0602'
    save_path = '/media/nvme/XZY/Results/results_name321_actions4/%s' % exp_name
...
def train(train_loader, model, criterion, optimizer, epoch):
   ...
   # print(accuracies)
    ...
    #print(i)
        ...
        # print("logits_identity", logits_identity.shape)
        # print("labels_identity", labels_identity.shape)
        ...
        loss = loss1 + loss2 + loss_identity_contra + loss_action_contra
